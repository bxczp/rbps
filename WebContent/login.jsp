	...
	<form id="form1" name="form1" action="user?action=login" method="post">
		<div class="MAIN">
			<ul>
				...
				<li class="topB">
					<span>
						<img src="${pageContext.request.contextPath }/images/login/logo.gif" alt="" style="" />
					</span>
				</li>
				<li class="topC"></li>
				<li class="topD">
						...
						<li>
							...
							<span style="">
								<input type="text" value="${imageCode }" name="imageCode" class="txtCode" id="imageCode" size="10"
									onkeydown="if(event.keyCode==13) form1.submit()" />
								&nbsp;
								<img onclick="javascript:loadimage();" title="点击换一张" name="randImage" id="randImage" src="images/image.jsp" width="60"
				...
				<li class="middle_C">
					<span class="btn">
						<img alt="登录" src="images/login/btnlogin.gif" onclick="javascript:document.getElementById('form1').submit()" />
					</span>
					&nbsp;&nbsp;
					<span>
